...
public class TongYiController {
	...
	@jakarta.annotation.Resource
	private TongYiService tongYiAudioTranscriptionServiceImpl;
	...
	public String audioTranscription(@RequestParam(value = "audioUrls",
		...
		return
				tongYiAudioTranscriptionServiceImpl.audioTranscription(url);
	}

	@jakarta.annotation.Resource
	private TongYiService tongYiTextEmbeddingServiceImpl;
	...
	public List<Double> textEmbedding(@RequestParam(value = "text",
		...
		return tongYiTextEmbeddingServiceImpl.textEmbedding(text);
	}
